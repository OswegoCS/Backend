...
public class CommentDaoImpl implements CommentDao {
    ...
    final private String INSERT_COMMENT = "INSERT INTO comments (post_id, content, user_id, publish_date) VALUES (:post_id, :content, (SELECT id FROM users WHERE screen_name = :screen_name), :publish_date)";
    ...
    final private String GET_LIKES = "SELECT user_id,screen_name FROM comment_likes INNER JOIN users ON users.id = comment_likes.user_id WHERE comment_id = :comment_id";
